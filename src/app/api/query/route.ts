...
"[RESTRICTED] Work experience data requires an access code. Request access via email (simangalisovilakazk1@icloud.com) or book a call: https://calendly.com/simangalisovilakazi/30min"
...
- explain [id]`;
        ...
        if (restrictedKeywords.some(kw => lowerQuery.includes(kw))) {
            return NextResponse.json({
                response: '[RESTRICTED] Work experience data requires an access code.\nRequest access via email (simangalisovilakazk1@icloud.com) or book a call: https://calendly.com/simangalisovilakazi/30min'
            });
        }
